...
echo "Iniciando importación de datos Red Social..."

# Verificar que existan los archivos necesarios
for file in usuarios.csv posts.csv relaciones.csv; do
...
sudo rm $NEO4J_IMPORT_DIR/{usuarios,posts,relaciones}.csv
