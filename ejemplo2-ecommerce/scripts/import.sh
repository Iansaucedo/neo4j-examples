...
echo "Iniciando importación de datos E-commerce..."

# Verificar que existan los archivos necesarios
for file in productos.csv categorias.csv compras.csv; do
...
sudo rm $NEO4J_IMPORT_DIR/{productos,categorias,compras}.csv
